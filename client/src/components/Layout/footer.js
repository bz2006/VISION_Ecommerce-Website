...
function footer() {
  return (
    <footer style={{backgroundColor:"rgb(218, 218, 218)", color:"black"}}>
        <Container>
        < Row xs={1} md={4} className="g-4 row-cols-md-2 row-cols-1">
      <Col >
        <a href="/">
          <img src="https://static.wixstatic.com/media/c1ec53_cdb43083bb05441ca9fb28a5027a7306~mv2.webp" fluid className='brimg' alt="Logo" />
        </a>
